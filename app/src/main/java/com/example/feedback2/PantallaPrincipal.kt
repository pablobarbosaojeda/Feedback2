...
fun PantallaPrincipal(
    novelas: List<Novela> = listOf(
        Novela("Novela de Ejemplo", "Autor Ejemplo", 2022, "Guanarteme", "Sinopsis"),
    ),
    onAgregarClick: () -> Unit,
    ...
    Scaffold(
        ...
        Box(
            ...
            // Añadir la foto del mapa al final de la pantalla
            Image(
                painter = painterResource(id = R.drawable.mapa), // Reemplaza "mapa" con tu recurso real
